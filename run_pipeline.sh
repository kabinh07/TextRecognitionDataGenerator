...
# Env overrides: FONT_SIZE, BLUR, STROKE_WIDTH, TEXT_COUNT, ADDR_COUNT, CONFUSION_COUNT
set -e
...
echo "=== Pipeline config: font_size=$FONT_SIZE blur=$BLUR stroke=$STROKE_WIDTH text=$TEXT_COUNT addr=$ADDR_COUNT confusion=$CONFUSION_COUNT ==="
